...
## About
Here is my current seetings for vim, bash and other tools like tmux. Please note that it is designed for my personal preferences and it is not ment as a general settings/installation.
